...
def add_username_segment():
  ...
  with open(current + configuration) as json_file:
    json_data = json.load(json_file)

  if json_data['segment']['userprompt']['value'] == "default":
    myvalue = user_prompt
  else:
    myvalue = json_data['segment']['userprompt']['value']

  # powerline.append(user_prompt, Color.USERNAME_FG, bgcolor)
  if json_data['segment']['userprompt']['status'] == True:
    powerline.append(myvalue, Color.USERNAME_FG, bgcolor)
